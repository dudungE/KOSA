...
public class GetAllByNameEx2 {
	public static void main(String[] args) throws UnknownHostException {  // 예외위임
		...
		byte[] addr = new byte[4];  // 192.168.230.178
		addr[0] = (byte)192;
		addr[1] = (byte)168;
		addr[2] = (byte)230;
		addr[3] = (byte)178;
		...
		InetAddress[] arr = InetAddress.getAllByName("www.naver.com");  // 223.130.192.247
//		InetAddress[] arr = InetAddress.getAllByName("www.naver.co.kr");  // 223.130.192.248
//		InetAddress[] arr = InetAddress.getAllByName("www.google.com");   // 142.250.198.36
//		InetAddress[] arr = InetAddress.getAllByName("www.google.co.kr");   // 142.250.196.227
